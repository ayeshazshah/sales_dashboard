...
•	Data Analysis: Data cleaning, transformation, and structuring were performed on the raw sales figures to ensure accuracy.
•	Data Visualization: Power BI was used as the primary tool to create the interactive charts and metrics, allowing for easy filtering and data exploration.
...
•	Profit Loss Areas: We are currently losing money on Leggings, Skirts, Kurti, Electronic Goods, and Furnishings. These need immediate attention.
•	Seasonal Slump: The business experiences a clear period of loss from May to September, showing negative profit (the red bars) during the summer and early fall months.
...
3.	Plan for the Slump: Develop a specific sales strategy for the May-September period. This could include major seasonal promotions, clearance events, or introducing high-demand seasonal items to counter the profit loss.
4.	Target High-Profit Cities: Focus additional marketing and logistical resources on Indore and Pune, as they are our most profitable markets.
